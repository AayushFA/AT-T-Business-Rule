...
{
  "id" : "BA_BPA_Validate_CI",
  "type" : "BusinessAction",
  "setupGroups" : [ "BPA_BA" ],
  "name" : "Validate Contract Item",
  "description" : null,
  "scope" : "Global",
...
*/
exports.operation0 = function (node,step,contractItemReference,zoomDataLookUp,webui,ugWrlnEng,ugWrlnSrc,bpaSingleSsLib,lib,bpaZoomLib,validationLib,aslLib) {
/***
...
if (node.isInWorkflow("Create_BPA")) {
	...
	if (tempPar != null) {
		var parent = step.getProductHome().getProductByID(tempPar);
	} else {
		var parent = null;
...
if (parent) {
	...
	if (CIStatus != "Closed") { //Phase 2 July 20 Release, STIBO-2512
		...
		log.info("regionDataCheck: " + regionDataCheck)
	...
	if (itemref.size() > 0) {
		lib.setItemLevelBuyerPlanner(node, itemref.get(0).getTarget(), step);
	}
	// STIBO-3318 Prod Support Team Mar 15 Release
}
}