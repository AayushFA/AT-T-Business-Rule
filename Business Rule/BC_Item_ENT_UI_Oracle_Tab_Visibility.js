...
{
  "id" : "BC_Item_ENT_UI_Oracle_Tab_Visibility",
  "type" : "BusinessCondition",
  "setupGroups" : [ "ATT_Item_Web_UI_Conditions" ],
  "name" : "Entertainment UI Oracle Attributes Tab Visibility",
  "description" : null,
  "scope" : "Global",
...
if ((dgUserGroup.isMember(curUser)||stiboUserGroup.isMember(curUser)||superUserGroup.isMember(curUser)) && lob == "ENT") {
    return true;
} else {
    return false;
}
