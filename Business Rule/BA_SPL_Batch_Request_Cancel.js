...
{
  "id" : "BA_SPL_Batch_Request_Cancel",
  "type" : "BusinessAction",
  "setupGroups" : [ "ATT_SPL_Web_UI_Actions" ],
  "name" : "SPL Batch Request Web UI Cancel Action",
  "description" : null,
  "scope" : "Global",
 ...
 * Cancels the current batch from Batch Request state
 */

log.info("Inside SPL Batch Request Cancel Business Action");
