...
{
  "id" : "BC_Validate_NTW_BOM_Type_Is_Not_NonStock",
  "type" : "BusinessCondition",
  "setupGroups" : [ "ATT_BOM_Web_UI_Conditions" ],
  "name" : "Validate NTW BOM Type is Not Non Stock",
  "description" : null,
  "scope" : "Global",
...
/**
 * @author - John [CTS]
 * Check Parent BOM is NTW or WRLN, Excluding NON Stock
 */
...
if (node.getObjectType().getID() == "Bill_Of_Material" && childrenExist.size() > 0 && parentBomType != "NON Stock") {
    return true;
} else {
    return false;
}
