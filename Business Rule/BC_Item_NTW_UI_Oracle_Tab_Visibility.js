...
{
  "id" : "BC_Item_NTW_UI_Oracle_Tab_Visibility",
  "type" : "BusinessCondition",
  "setupGroups" : [ "ATT_Item_Web_UI_Conditions" ],
  "name" : "Network UI Oracle Attributes Tab Visibility",
  "description" : null,
  "scope" : "Global",
...
if ((dgUserGroup.isMember(curUser)||stiboUserGroup.isMember(curUser)||superUserGroup.isMember(curUser)) && lob == "NTW") {
    return true;
} else {
    return false;
}
