...
{
  "id" : "BC_CheckObjTypecCI_BPAnodoesntExist_ENT",
  "type" : "BusinessCondition",
  "setupGroups" : [ "BPA_BC" ],
  "name" : "Check if CI-Item Refernce Editable True (ENT & WRLN)",
  "description" : null,
  "scope" : "Global",
...
if (objectType == 'Contract_Item') {
	...
	var BPAno = parent.getValue("Oracle_Contract_Num").getSimpleValue();
	var lob = node.getParent().getValue("Legacy_Source").getID();
	log.info("isProcessedInEBS(node):"+isProcessedInEBS(node));
