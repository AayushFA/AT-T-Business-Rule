...
{
  "id" : "BC_CheckObjTypecCI_BPAnoExist_WRLN",
  "type" : "BusinessCondition",
  "setupGroups" : [ "BPA_BC" ],
  "name" : "Check if CI-Item Refernce Editable False(WRLN)",
  "description" : null,
  "scope" : "Global",
...
/**
 * @author - Piyal [CTS]
 * Check if object type Contract item OR CILE And BPA no Exist(WRLN)
 */
...
if(objectType=='Contract_Item'){
	...
	if(isProcessedInEBS(node)&& BPAno!=null && (lob=="WRLN_NON" || lob=="WRLN" || lob=="QTE")){
