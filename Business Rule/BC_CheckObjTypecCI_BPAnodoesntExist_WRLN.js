...
{
  "id" : "BC_CheckObjTypecCI_BPAnodoesntExist_WRLN",
  "type" : "BusinessCondition",
  "setupGroups" : [ "BPA_BC" ],
  "name" : "Check if CI-Item Refernce Editable True(WRLN)",
  "description" : null,
  "scope" : "Global",
...
/**
 * @author - Piyal [CTS]
 * Check if object type Contract item OR CILE And BPA no does not Exist(WRLN)
 */
...
if(objectType=='Contract_Item'){
	...
	if(!isProcessedInEBS(node)&& (lob=="WRLN_NON" || lob=="WRLN" || lob=="QTE")){	
		return true		
	}
	else{		
		return false
