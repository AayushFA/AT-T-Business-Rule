...
{
  "id" : "BC_Item_RTL_UI_Oracle_Tab_Visibility",
  "type" : "BusinessCondition",
  "setupGroups" : [ "ATT_Item_Web_UI_Conditions" ],
  "name" : "Retail UI Oracle Attributes Tab Visibility",
  "description" : null,
  "scope" : "Global",
...
if ((dgUserGroup.isMember(curUser)||stiboUserGroup.isMember(curUser)||superUserGroup.isMember(curUser)) && lob == "RTL") {
    return true;
} else {
    return false;
}
