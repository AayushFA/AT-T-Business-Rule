...
{
  "id" : "BC_CheckObjTypecCI_BPAnoExist_ENT",
  "type" : "BusinessCondition",
  "setupGroups" : [ "BPA_BC" ],
  "name" : "Check if CI-Item Refernce Editable False(ENT & WRLN)",
  "description" : null,
  "scope" : "Global",
...
/**
 * @author - Piyal [CTS]
 * Check if object type Contract item OR CILE And BPA no Exist(ENT)
 */
